...
describe('AnchoredFloatingBoxComponent', () => {
  ...
  it('Should have "<span>Hello World</span>" as the body', () => {
    ...
    fixture.detectChanges();
    expect(debugElement.query(By.css(`${classPrefix}__content`)).nativeElement.innerHTML).toBe(
  ...
  it('Should be placed at the bottom of anchor element', fakeAsync(() => {
    ...
    fixture.detectChanges();
    tick();
    expect(debugElement.query(By.css('.top'))).toBeNull();
    expect(debugElement.query(By.css('.bottom'))).not.toBeNull();
  }));
  ...
  it('Should be placed at the top of the anchor if it overflows the bottom edge of the viewport', fakeAsync(() => {
    ...
    tick();
    expect(debugElement.query(By.css('.bottom'))).toBeNull();
    expect(debugElement.query(By.css('.top'))).not.toBeNull();
  }));
  ...
  it('Should use light theme by default', () => {
    ...
    expect(debugElement.query(By.css('.light'))).not.toBeNull();
  });
});
